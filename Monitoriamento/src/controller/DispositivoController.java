...
public class DispositivoController {
        ...
        while (continuar) {
            ...
            switch (opcao) {
                ...
                case 2:
                    ...
                    break;
                case 3:
                    DispositivoController.removerDispositivo(dispositivos);
                    break;
                case 4:
                    DispositivoController.atualizarDispositivo(dispositivos);
                    break;
                case 5:
                    continuar = false;
                    break;
    ...
    public static DispositivoModel cadastrarDispositivo(Scanner sc) {
        ...
        AlertaMenuController.verificarLimites(tipo, unidadeMedida, valor);
    ...
    public static void removerDispositivo(ArrayList<DispositivoModel> dispositivos) {
        Scanner sc = new Scanner(System.in);
    ...
    public static void atualizarDispositivo(ArrayList<DispositivoModel> dispositivos) {
        Scanner sc = new Scanner(System.in);
